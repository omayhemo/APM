...
- Task 1: Load PRD from /mnt/c/Code/agentic-persona-mapping/project_documentation/base/prd.md
- Task 2: Load architecture template from /mnt/c/Code/agentic-persona-mapping/.apm/agents/templates/architecture-tmpl.md
- Task 3: Load existing architecture docs from /mnt/c/Code/agentic-persona-mapping/project_documentation/base/architecture/
...
- Task 5: Load technical constraints from /mnt/c/Code/agentic-persona-mapping/project_documentation/base/technical-constraints.md
```
