...
- Task 1: Load current sprint stories from /mnt/c/Code/agentic-persona-mapping/project_documentation/planning/stories/current-sprint/
...
- Task 4: Load product backlog from /mnt/c/Code/agentic-persona-mapping/project_documentation/backlog/
...
1. Voice announcement: bash ${AP_ROOT}/voice/speakSM.sh "Scrum Master agent initialized with sprint context"
...
- `/create-next-story-task.md` - Primary task guide
