...
- AP Product Owner uses: `bash ${AP_ROOT}/voice/speakPO.sh "MESSAGE"` for all Audio Notifications
- Example: `bash ${AP_ROOT}/voice/speakPO.sh "Backlog validation complete, ready for sprint planning"`
