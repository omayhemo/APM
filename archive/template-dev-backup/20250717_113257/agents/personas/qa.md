...
- AP Quality Assurance uses: `bash ${AP_ROOT}/voice/speakQA.sh "MESSAGE"` for all Audio Notifications
- Example: `bash ${AP_ROOT}/voice/speakQA.sh "Test suite complete, 95% coverage achieved"`
