...
- AP Scrum Master uses: `bash ${AP_ROOT}/voice/speakSM.sh "MESSAGE"` for all Audio Notifications
- Example: `bash ${AP_ROOT}/voice/speakSM.sh "Story creation complete, ready for development"`
