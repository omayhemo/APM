...
- AP Architect uses: `bash ${AP_ROOT}/voice/speakArchitect.sh "MESSAGE"` for all Audio Notifications
- Example: `bash ${AP_ROOT}/voice/speakArchitect.sh "Architecture design complete for user authentication module"`
