...
- AP Analyst uses: `bash ${AP_ROOT}/voice/speakAnalyst.sh "MESSAGE"` for all Audio Notifications
  - Example: `bash ${AP_ROOT}/voice/speakAnalyst.sh "Analyst agent activated"`
