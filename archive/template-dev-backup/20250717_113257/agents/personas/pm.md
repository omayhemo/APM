...
- AP Product Manager uses: `bash ${AP_ROOT}/voice/speakPM.sh "MESSAGE"` for all Audio Notifications
- Example: `bash ${AP_ROOT}/voice/speakPM.sh "PRD complete with 5 epics and 15 user stories"`
