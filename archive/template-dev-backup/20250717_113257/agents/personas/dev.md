...
- AP Developer uses: `bash ${AP_ROOT}/voice/speakDeveloper.sh "MESSAGE"` for all Audio Notifications
- Example: `bash ${AP_ROOT}/voice/speakDeveloper.sh "Story implementation complete, all tests passing"`
...
- Provide milestone updates using:\
  `bash ${AP_ROOT}/voice/speakDeveloper.sh "MESSAGE"`
