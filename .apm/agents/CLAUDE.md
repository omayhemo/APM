...
- APM Infrastructure: /mnt/c/Code/agentic-persona-mapping/.apm (agents should ignore)
...
- `/mnt/c/Code/agentic-persona-mapping/.apm/` - APM infrastructure (hidden)
...
- Use `git diff /mnt/c/Code/agentic-persona-mapping/project_docs/backlog.md` to verify updates
