...
3. **Review existing documentation** in `@$PROJECT_DOCS/` including:
   - `/planning/epics/` - Check existing epics to avoid duplication and ensure consistency
   - `/planning/stories/` - Understand the story format and numbering conventions
...
- **Epic ID:** [EPIC-XXX] *(Check @/planning/epics/ for next available number)*
...
- [Link to related work or dependent epics from @/planning/epics/]
