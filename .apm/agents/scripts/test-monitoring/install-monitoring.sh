...
QA_REPORTS_DIR="/mnt/c/Code/agentic-persona-mapping/project_docs/qa"
...
environment:
  ...
  apm_root: "/mnt/c/Code/agentic-persona-mapping/.apm"
  qa_reports_dir: "/mnt/c/Code/agentic-persona-mapping/project_docs/qa"
  scripts_dir: "/mnt/c/Code/agentic-persona-mapping/.apm/scripts/test-monitoring"
...
alias apm-monitor="/mnt/c/Code/agentic-persona-mapping/.apm/scripts/test-monitoring/monitor-tests.sh"
alias apm-dashboard="/mnt/c/Code/agentic-persona-mapping/.apm/scripts/test-monitoring/test-dashboard.sh"
alias apm-metrics="/mnt/c/Code/agentic-persona-mapping/.apm/scripts/test-monitoring/test-metrics-collector.sh"

# Monitoring shortcuts
alias monitor-tests="/mnt/c/Code/agentic-persona-mapping/.apm/scripts/test-monitoring/monitor-tests.sh"
alias test-dashboard="/mnt/c/Code/agentic-persona-mapping/.apm/scripts/test-monitoring/test-dashboard.sh"
alias test-metrics="/mnt/c/Code/agentic-persona-mapping/.apm/scripts/test-monitoring/test-metrics-collector.sh"

# Quick monitoring commands
alias show-test-status="/mnt/c/Code/agentic-persona-mapping/.apm/scripts/test-monitoring/monitor-tests.sh --once"
alias monitor-processes="/mnt/c/Code/agentic-persona-mapping/.apm/scripts/test-monitoring/monitor-tests.sh --processes"
alias monitor-reports="/mnt/c/Code/agentic-persona-mapping/.apm/scripts/test-monitoring/monitor-tests.sh --reports"

# Dashboard variants
alias exec-dashboard="/mnt/c/Code/agentic-persona-mapping/.apm/scripts/test-monitoring/test-dashboard.sh --mode executive"
alias metrics-dashboard="/mnt/c/Code/agentic-persona-mapping/.apm/scripts/test-monitoring/test-dashboard.sh --mode metrics"

# Export commands
alias export-test-metrics-csv="/mnt/c/Code/agentic-persona-mapping/.apm/scripts/test-monitoring/test-metrics-collector.sh --export csv"
alias export-test-metrics-json="/mnt/c/Code/agentic-persona-mapping/.apm/scripts/test-monitoring/test-metrics-collector.sh --export json"

# Help commands
alias apm-monitor-help="/mnt/c/Code/agentic-persona-mapping/.apm/scripts/test-monitoring/monitor-tests.sh --help"
alias apm-dashboard-help="/mnt/c/Code/agentic-persona-mapping/.apm/scripts/test-monitoring/test-dashboard.sh --help"
alias apm-metrics-help="/mnt/c/Code/agentic-persona-mapping/.apm/scripts/test-monitoring/test-metrics-collector.sh --help"
...
See `/mnt/c/Code/agentic-persona-mapping/.apm/config/test-monitoring.yaml` for configuration options.
...
`/mnt/c/Code/agentic-persona-mapping/.apm/templates/scripts/test-monitoring/README.md.template`
EOF
