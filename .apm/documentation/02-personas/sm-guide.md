# Scrum Master Agent Complete Guide
...
2. Story Readiness Check
   └─ /parallel-checklist "Validate all candidate stories meet Definition of Ready"
...
2. Retrospective Preparation
   └─ /parallel-checklist "Prepare retrospective agenda and discussion points"
...
/parallel-checklist "Prepare sprint planning checklist, Definition of Ready validation, and team readiness assessment"
```
...
/parallel-checklist "Create story quality checklist and Definition of Ready validation criteria"
```
...
- **Stories**: `/mnt/c/Code/agentic-persona-mapping/project_docs/sprints/stories/`
...
/parallel-checklist "Create story quality checklist and Definition of Ready validation process"
```
...
/parallel-checklist "Create comprehensive facilitation checklists for all sprint ceremonies"
```
...
/parallel-checklist "Create coordination checklists for multi-team sprint management"
```
