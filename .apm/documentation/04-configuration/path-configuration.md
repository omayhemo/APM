...
Configure paths in `/mnt/c/Code/agentic-persona-mapping/.apm/settings.json`:
...
```json
{
  "paths": {
    ...
    "generated_personas": "/mnt/c/Code/agentic-persona-mapping/.apm/agents/personas",
    "voice_scripts": "/mnt/c/Code/agentic-persona-mapping/.apm/agents/voice",
    "session_notes": "/mnt/c/Code/agentic-persona-mapping/.apm/session_notes",
    "session_archive": "/mnt/c/Code/agentic-persona-mapping/.apm/session_notes/archive",
    "rules": "/mnt/c/Code/agentic-persona-mapping/.apm/rules",
    "logs": "/mnt/c/Code/agentic-persona-mapping/.apm/logs",
    "temp": "/mnt/c/Code/agentic-persona-mapping/.apm/temp",
    "config": "/mnt/c/Code/agentic-persona-mapping/.apm/config"
  },
  "path_resolution": {
    "auto_create_missing": true,
    "validate_permissions": true,
    "relative_path_base": "/mnt/c/Code/agentic-persona-mapping",
...
Create dedicated path configuration at `/mnt/c/Code/agentic-persona-mapping/.apm/config/path-config.json`:
...
```json
{
  ...
  "core_paths": {
    ...
    "project_root": {
      "path": "/mnt/c/Code/agentic-persona-mapping",
  ...
  "framework_paths": {
    "agents": {
      "path": "/mnt/c/Code/agentic-persona-mapping/.apm/agents",
      "description": "Agent-related files and configurations",
      "auto_create": true,
      "permissions": "755"
    },
    "personas": {
      "path": "/mnt/c/Code/agentic-persona-mapping/.apm/agents/personas",
    ...
    "voice_scripts": {
      "path": "/mnt/c/Code/agentic-persona-mapping/.apm/agents/voice",
    ...
    "hooks": {
      "path": "/mnt/c/Code/agentic-persona-mapping/.apm/hooks",
  ...
  "session_paths": {
    "session_notes": {
      "path": "/mnt/c/Code/agentic-persona-mapping/.apm/session_notes",
    ...
    "session_archive": {
      "path": "/mnt/c/Code/agentic-persona-mapping/.apm/session_notes/archive",
    ...
    "session_templates": {
      "path": "/mnt/c/Code/agentic-persona-mapping/.apm/templates",
  ...
  "configuration_paths": {
    "config": {
      "path": "/mnt/c/Code/agentic-persona-mapping/.apm/config",
    ...
    "rules": {
      "path": "/mnt/c/Code/agentic-persona-mapping/.apm/rules",
  ...
  "operational_paths": {
    "logs": {
      "path": "/mnt/c/Code/agentic-persona-mapping/.apm/logs",
    ...
    "temp": {
      "path": "/mnt/c/Code/agentic-persona-mapping/.apm/temp",
    ...
    "cache": {
      "path": "/mnt/c/Code/agentic-persona-mapping/.apm/cache",
  ...
  "integration_paths": {
    "claude_commands": {
      "path": "/mnt/c/Code/agentic-persona-mapping/.claude/commands",
    ...
    "project_docs": {
      "path": "/mnt/c/Code/agentic-persona-mapping/project_docs",
...
```json
{
  ...
  "path_overrides": {
    "logs": {
      "path": "/mnt/c/Code/agentic-persona-mapping/.apm/logs/development",
      "log_level": "debug",
      "retention_days": 7
    },
    "temp": {
    ...
    "session_notes": {
      "path": "/mnt/c/Code/agentic-persona-mapping/.apm/session_notes/dev",
      "auto_backup": true,
...
```json
{
  ...
  "custom_paths": {
    "frontend_docs": "/mnt/c/Code/agentic-persona-mapping/docs/frontend",
    "backend_docs": "/mnt/c/Code/agentic-persona-mapping/docs/backend",
    "api_specs": "/mnt/c/Code/agentic-persona-mapping/docs/api",
    "deployment_configs": "/mnt/c/Code/agentic-persona-mapping/deployment",
    "test_reports": "/mnt/c/Code/agentic-persona-mapping/reports/testing",
    "performance_logs": "/mnt/c/Code/agentic-persona-mapping/.apm/logs/performance",
    "security_audits": "/mnt/c/Code/agentic-persona-mapping/.apm/logs/security"
  }
}
```
...
Create `/mnt/c/Code/agentic-persona-mapping/.apm/scripts/validate-paths.sh`:
...
Create `/mnt/c/Code/agentic-persona-mapping/.apm/scripts/setup-paths.sh`:
...
expand_path_variables() {
    ...
    if [ -f "/mnt/c/Code/agentic-persona-mapping/.apm/project-context.json" ]; then
        local project_name=$(jq -r '.project.name // "unknown"' /mnt/c/Code/agentic-persona-mapping/.apm/project-context.json)
        local project_version=$(jq -r '.project.version // "unknown"' /mnt/c/Code/agentic-persona-mapping/.apm/project-context.json)
...
migrate_from_3_5_0() {
    ...
    find "/mnt/c/Code/agentic-persona-mapping/.apm/config" -name "*.json" -exec sed -i 's|/personas/legacy/|/agents/personas/|g' {} \;
    
    # Migrate session notes structure
    echo "Migrating session notes structure..."
    if [ -d "/mnt/c/Code/agentic-persona-mapping/.apm/sessions" ]; then
...
cleanup_paths() {
    ...
    if [ -d "/mnt/c/Code/agentic-persona-mapping/.apm/temp" ]; then
        find "/mnt/c/Code/agentic-persona-mapping/.apm/temp" -type f -mtime +1 -delete
        find "/mnt/c/Code/agentic-persona-mapping/.apm/temp" -type d -empty -delete
    fi
    
    # Rotate logs based on policy
    echo "Rotating logs..."
    rotate_logs "/mnt/c/Code/agentic-persona-mapping/.apm/logs" "30"  # Keep 30 days
    
    # Archive old session notes
    echo "Archiving old session notes..."
    archive_old_sessions "/mnt/c/Code/agentic-persona-mapping/.apm/session_notes" "7"  # Archive after 7 days
    
    # Clean cache based on LRU policy
    echo "Cleaning cache..."
    clean_cache "/mnt/c/Code/agentic-persona-mapping/.apm/cache" "100MB"  # Keep max 100MB
...
/mnt/c/Code/agentic-persona-mapping/.apm/scripts/setup-paths.sh
```
...
**Symptoms**: Paths contain unexpanded variables like /mnt/c/Code/agentic-persona-mapping/.apm
**Solutions**:
```bash
...
echo "/mnt/c/Code/agentic-persona-mapping/.apm/test" | envsubst

# Verify configuration file syntax
jq empty "/mnt/c/Code/agentic-persona-mapping/.apm/config/path-config.json"
```
