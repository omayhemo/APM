...
**File**: `/mnt/c/Code/agentic-persona-mapping/project-config.json`
...
**Files**: `/mnt/c/Code/agentic-persona-mapping/installer/personas/_master/*.persona.json`
...
**File**: `/mnt/c/Code/agentic-persona-mapping/.apm/config/hooks-config.json`
...
**File**: `/mnt/c/Code/agentic-persona-mapping/.apm/config/voice-config.json`
...
**File**: `/mnt/c/Code/agentic-persona-mapping/.apm/config/session-config.json`
...
**File**: `/mnt/c/Code/agentic-persona-mapping/.apm/config/parallel-config.json`
...
```json
{
  "validation_rules": {
    "required_files": [
      "/mnt/c/Code/agentic-persona-mapping/.apm/config/apm-config.json",
      "/mnt/c/Code/agentic-persona-mapping/.apm/config/persona-config.json"
    ],
    "optional_files": [
      "/mnt/c/Code/agentic-persona-mapping/.apm/config/hooks-config.json",
      "/mnt/c/Code/agentic-persona-mapping/.apm/config/voice-config.json",
      "/mnt/c/Code/agentic-persona-mapping/.apm/config/session-config.json",
      "/mnt/c/Code/agentic-persona-mapping/.apm/config/parallel-config.json"
    ],
    "path_validation": {
...
/mnt/c/Code/agentic-persona-mapping/.apm/scripts/validate-config.sh --config apm-config.json

# Generate schema documentation
/mnt/c/Code/agentic-persona-mapping/.apm/scripts/generate-schema-docs.sh
```
