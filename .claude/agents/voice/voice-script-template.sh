...
log_voice_activity() {
    ...
    if [ "${TTS_DEBUG:-false}" = "true" ]; then
        ...
        local log_file="/mnt/c/Code/agentic-persona-mapping/.cache/tts/voice.log"
...
Files:
    ...
    Log File: /mnt/c/Code/agentic-persona-mapping/.cache/tts/voice.log
...
# - Settings must be configured in /mnt/c/Code/agentic-persona-mapping/.claude/settings.json
#
# Testing:
