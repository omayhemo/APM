---
name: qa-qa-test-strategy
description: Sequential test strategy development and planning with parallel execution option
metadata:
  version: 2.0.0
  agent: QA
...
```markdown
*Loading QA context for qa-qa-test-strategy...*
...
```
I'm launching sequential qa-test-strategy for comprehensive development and analysis.

*Loading qa-test-strategy templates and methodologies...*
[Execute initialization tasks in sequence]
- Load qa-test-strategy templates and frameworks
...
**Objective**: Execute core qa-test-strategy activities
...
After qa-test-strategy completion:
...
```bash
bash /mnt/c/Code/agentic-persona-mapping/.apm/agents/voice/speakQA.sh "Sequential qa-test-strategy beginning. Launching guided development process..."
```
...
**Use `/qa-qa-test-strategy --parallel` when:**
...
This command provides thoughtful, systematic qa-test-strategy with emphasis on quality, stakeholder collaboration, and comprehensive coverage.
...
- Task 2: Load quality requirements from /mnt/c/Code/agentic-persona-mapping/project_docs/planning-requirements/
- Task 3: Load system architecture from /mnt/c/Code/agentic-persona-mapping/project_docs/planning-architecture/
...
When you run `/qa-qa-test-strategy --parallel`, I will:
...
```yaml
# parallel-qa-test-strategy-config.yaml
