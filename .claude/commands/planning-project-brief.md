...
**Product Manager Agent Only**: Executes structured planning-project-brief through guided sequential methodology.
...
The `/planning-project-brief` command enables the Product Manager to execute planning-project-brief through:
- Sequential development with focused attention on each aspect
- Interactive guidance through planning-project-brief components  
...
```
I'm launching sequential planning-project-brief for comprehensive development and analysis.

*Loading planning-project-brief templates and methodologies...*
[Execute initialization tasks in sequence]
- Load planning-project-brief templates and frameworks
...
**Objective**: Execute core planning-project-brief activities
...
After planning-project-brief completion:
...
```bash
bash /mnt/c/Code/agentic-persona-mapping/.apm/agents/voice/speakAnalyst.sh "Sequential planning-project-brief beginning. Launching guided development process..."
```
...
**Use `/planning-project-brief` when:**
...
**Use `/parallel-planning-planning-project-brief` when:**
...
This command provides thoughtful, systematic planning-project-brief with emphasis on quality, stakeholder collaboration, and comprehensive coverage.
