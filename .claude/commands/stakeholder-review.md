...
description: Sequential stakeholder analysis and review process
metadata:
  version: 1.0.0
  agent: Analyst
...
# Sequential Stakeholder-review Command

**Analyst Agent Only**: Executes structured stakeholder-review through guided sequential methodology.
...
The `/stakeholder-review` command enables the Analyst to execute stakeholder-review through:
- Sequential development with focused attention on each aspect
- Interactive guidance through stakeholder-review components  
