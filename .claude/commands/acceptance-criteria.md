...
description: Sequential acceptance criteria definition process
metadata:
  version: 1.0.0
  agent: Product Owner
...
# Sequential Acceptance-criteria Command

**Product Owner Agent Only**: Executes structured acceptance-criteria through guided sequential methodology.
...
The `/acceptance-criteria` command enables the Product Owner to execute acceptance-criteria through:
- Sequential development with focused attention on each aspect
- Interactive guidance through acceptance-criteria components  
...
```
I'm launching sequential acceptance-criteria for comprehensive development and analysis.

*Loading acceptance-criteria templates and methodologies...*
[Execute initialization tasks in sequence]
- Load acceptance-criteria templates and frameworks
- Review context and requirements
- Prepare systematic methodology
- Set up validation and documentation processes
```

## Sequential Acceptance-criteria Process
...
**Objective**: Execute core acceptance-criteria activities
...
After acceptance-criteria completion:
...
## Overview
- **Acceptance-criteria Type**: [Type/Category]
- **Agent**: Product Owner
...
```bash
bash /mnt/c/Code/agentic-persona-mapping/.apm/agents/voice/speakPO.sh "Sequential acceptance-criteria beginning. Launching guided development process..."
```
...
**Use `/parallel-acceptance-criteria` when:**
...
This command provides thoughtful, systematic acceptance-criteria with emphasis on quality, stakeholder collaboration, and comprehensive coverage.
