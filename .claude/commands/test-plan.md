---
name: qa-qa-test-plan
description: Sequential test planning with comprehensive coverage with parallel execution option
metadata:
  version: 2.0.0
  agent: QA
...
```markdown
*Loading QA context for qa-qa-test-plan...*
...
```
I'm launching sequential qa-test-plan for comprehensive development and analysis.

*Loading qa-test-plan templates and methodologies...*
[Execute initialization tasks in sequence]
- Load qa-test-plan templates and frameworks
...
**Objective**: Execute core qa-test-plan activities
...
```bash
bash /mnt/c/Code/agentic-persona-mapping/.apm/agents/voice/speakQA.sh "Sequential qa-test-plan beginning. Launching guided development process..."
```
...
**Use `/qa-qa-test-plan --parallel` when:**
...
This command provides thoughtful, systematic qa-test-plan with emphasis on quality, stakeholder collaboration, and comprehensive coverage.
...
- Task 2: Load requirements documentation from /mnt/c/Code/agentic-persona-mapping/project_docs/planning-requirements/
...
When you run `/qa-qa-test-plan --parallel`, I will:
...
```yaml
# parallel-qa-test-plan-config.yaml
parallel_test_plan:
  streams: 6
