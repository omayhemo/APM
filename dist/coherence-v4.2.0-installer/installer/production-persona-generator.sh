...
$(get_parallel_commands_claude "$persona_id")
...
### Available Parallel Commands
- `/parallel-planning-review` - Comprehensive code planning-review with multiple focus areas
...
### Available Parallel Commands
- `/parallel-planning-prd` - Comprehensive product requirements development
...
# Get parallel commands for Claude templates
get_parallel_commands_claude() {
    local persona_id="$1"
    case "$persona_id" in
        "analyst")
        ...
        "design-architect")
            ...
            ;;
        "developer")
            echo "- **\`/parallel-planning-review\`**: Multi-focus code planning-review and analysis"
            echo "- **\`/parallel-implementation\`**: Parallel development streams"
            echo "- **\`/parallel-testing\`**: Multi-layer testing strategy execution"
            ;;
        "pm")
            echo "- **\`/parallel-planning-prd\`**: Comprehensive product requirements development"
