...
cp templates/templates/scripts/tts-manager.sh "$AP_ROOT/scripts/"
cp templates/templates/scripts/configure-tts.sh "$AP_ROOT/scripts/"
cp templates/templates/scripts/tts-providers/*.sh "$AP_ROOT/scripts/tts-providers/"
cp templates/templates/voice/*.sh "$AP_ROOT/voice/"
