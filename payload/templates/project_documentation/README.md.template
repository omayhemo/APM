...
- **Architect**: `/parallel-planning-architecture-review` for system-wide analysis using unified context patterns
- **Design Architect**: Parallel component and UI/UX analysis with Coherence design principles
- **PO**: `/planning-groom` with 18 native sub-agents for backlog optimization using unified context engineering
- **SM**: `/parallel-implementation-sprint` coordinating 2-4 Developer sub-agents with Coherence coordination patterns
