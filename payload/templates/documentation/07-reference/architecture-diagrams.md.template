# Coherence Architecture Diagrams & Technical Specifications

System architecture diagrams, data flow visualizations, and technical explanations for the Coherence - Agentic Persona Mapping framework.
...
graph TB
    ...
    subgraph "Coherence Framework Core"
        ORCH[Coherence Orchestrator]
        CMD[Command Router]
...
#### 2. Coherence Framework Core
- **Coherence Orchestrator**: Central coordination and delegation engine
...
### Coherence v4.1.0 Native Sub-Agent System
...
graph TB
    ...
    subgraph "Coherence Sub-Agent Management"
...
### Performance Comparison: Legacy vs v4.1.0

| Operation | v4.1.0 (Task Tool) | v4.1.0 (Native) | Improvement |
|-----------|-------------------|------------------|-------------|
...
sequenceDiagram
    ...
    participant Orch as Coherence Orchestrator
